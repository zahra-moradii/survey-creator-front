...
@Component({
  selector: 'app-active-form-reviews',
  templateUrl: './active-form-reviews.component.html',
  styleUrls: ['./active-form-reviews.component.scss']
})
export class ActiveFormReviewsComponent implements OnInit {
  surveys: any | object;
